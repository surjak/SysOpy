...
int main(int argc, char **argv)
{
    ...
    else if (strcmp(mode, "check") == 0)
    {
        ...
        while (fgets(input_line, PATH_MAX * 3 + 3, input_file) != NULL)
        {
            ...
            // puts(a_filenames[pair_counter]);
            // puts(b_filenames[pair_counter]);
            // puts(c_filenames[pair_counter]);
        ...
        // bool correct = check_multiply_correctness(a_filename, b_filename, c_filename);
        // if (correct)
        // {
        //     puts("mnozenie poprawne");
        // }
